...
public class ProductService {
    ...
    //PRODUCTS: System provides these products
    private static final Map<String, Product> PRODUCTS = new LinkedHashMap<>();

    //we need save id in PRODUCTS for getProductById method
    static {
        PRODUCTS.put("P1", new Product("P1", "Adhari bottled water", "High performance laptop", 999.99));
        ...
        PRODUCTS.put("P4", new Product("P4", "kilo potato", "27-inch 4K monitor", 349.99));
        ...
        PRODUCTS.put("P7", new Product("P7", "frozen steak ", "7-port USB 3.0 hub", 39.99));
