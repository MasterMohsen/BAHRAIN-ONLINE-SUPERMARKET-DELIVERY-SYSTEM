...
public class ProductService {
    ...
    static {
        PRODUCTS.put("P1", new Product("P1", "Adhari bottled water", "300ml of water", 999.99));
        ...
        PRODUCTS.put("P4", new Product("P4", "kilo potato", "Bahraini potato", 349.99));
        ...
        PRODUCTS.put("P7", new Product("P7", "frozen steak ", "Steak from Madinat alhoom", 39.99));
